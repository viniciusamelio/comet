...
<Cards>
  ...
  <Card title="Typed RPC" href="/en/docs/rpc">
    Route inspection and generated TypeScript, Dart, and Rust clients for
    Rocket routes with JSON request/response contracts.
  </Card>
